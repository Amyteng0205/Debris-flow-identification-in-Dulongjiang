# -*- coding: utf-8 -*-
"""
Created on Wed Jan  4 10:38:11 2023
...
def objective(trial, data=X, target=y):
    ...
    param = {
        ...
        # max AUPRC: 0.9255218794366649
        # Best trial: {'C': 10, 'gamma': 1}
        
        'C': trial.suggest_categorical('C', [0.01, 0.03, 0.1, 0.3, 1, 3, 10, 30, 100]),
        'gamma': trial.suggest_categorical('gamma', [0.01, 0.03, 0.1, 0.3, 1, 3, 10, 30, 100]),
        'probability': True
...
plotly.offline.plot(optimization_history, filename='Optimization_history_plot_SVM.html')
plotly.offline.plot(param_importances, filename='param_importances_plot_SVM.html') 